...
const submitUpload = () => {
    form.post(route('pets.upload'));
}

const onFileChange = () => {
    uploadForm.uploadFile = document.getElementById('file-upload').fileInput.files[0]
    ...
    <div class="max-w-2xl mx-auto mt-8">
        <form @submit.prevent="submitForm">
            ...
            <div class="grid grid-cols-2 gap-4 mb-4 border">
                <div class="col-span-2 sm:col-span-1 border">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="border-2 border-green-500 border-dashed rounded-md p-4">
                        <label for="file-upload" class="text-2xl font-medium btn-upload block">Choose a file</label>
                        <input id="file-upload" type="file" class="hidden" v-on:change="onFileChange" />
                        <button type="button" class="btn-plus" @click="submitUpload">
                            +
                        </button>
                    </div>
